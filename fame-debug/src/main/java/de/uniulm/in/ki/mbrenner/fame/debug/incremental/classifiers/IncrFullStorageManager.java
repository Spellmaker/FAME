 ...
 */
public class IncrFullStorageManager implements HierarchyManager {
    ...
    public IncrFullStorageManager(OWLReasonerFactory factory){
        this.factory = factory;
    }

    public IncrFullStorageManager(OWLReasonerFactory factory, Set<OWLClass> classes){
        this.factory = factory;
    ...
    public Hierarchy determineHierarchy(OWLOntology ontology, Hierarchy previous, Collection<OWLAxiom> added, Collection<OWLAxiom> removed, Collection<OWLClass> newSymbols) {
        ...
        ModificationResult modRes = extractor.modifyOntology(added, removed);
