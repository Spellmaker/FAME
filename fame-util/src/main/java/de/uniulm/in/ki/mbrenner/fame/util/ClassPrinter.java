...
public class ClassPrinter {
	...
	public static String printClass(Object oce){
		...
		if(oce instanceof OWLObjectIntersectionOf){
			...
			s = "E " + printClass(ex.getProperty()) + "." + printClass(ex.getFiller());//printIRI(ex.getProperty().asOWLObjectProperty().getIRI().toString()) + "." + printClass(ex.getFiller());
		}
		else if(oce instanceof OWLClass){
			s = "(C)" + printIRI(((OWLClass)oce).getIRI().toString());
		}
		else if(oce instanceof OWLProperty){
			s = "(P)" + printIRI(((OWLProperty) oce).getIRI().toString());
		}
