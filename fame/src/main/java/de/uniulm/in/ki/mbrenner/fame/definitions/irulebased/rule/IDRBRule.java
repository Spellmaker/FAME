...
public class IDRBRule implements Iterable<Integer>{
     ...
     */
    public final Set<IDRBDefinition> definitions;
    /**
     ...
     */
    public IDRBRule(Integer head, Integer axiom, @Nonnull Set<IDRBDefinition> definitions, @Nonnull Integer...body){
     ...
     */
    public @Nonnull Integer getHeadOrAxiom(){
    ...
    public boolean equals(Object o){
        if(o instanceof IDRBRule){
            IDRBRule other = (IDRBRule) o;
